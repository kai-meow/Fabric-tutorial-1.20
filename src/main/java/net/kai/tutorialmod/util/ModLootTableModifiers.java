package net.kai.tutorialmod.util;
...
public class ModLootTableModifiers {
    ...
    private static final Identifier JUNTLE_TEMPLE_ID =
    ...
    public static void modifyLootTables() {
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            ...
            if(CREEPER_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .with(ItemEntry.builder(ModItems.RAW_CRACK))
        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            ...
            if(SUSPICIOUS_SAND_ID.equals(id)){
                ...
                entries.add(ItemEntry.builder(ModItems.STUPID_GUN).build());
